import { version, unref, inject, defineComponent, ref, provide, createElementBlock, useSSRContext, withAsyncContext, mergeProps, createApp, effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance, computed, toValue, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, defineAsyncComponent, h, isReadonly, isRef, isShallow, isReactive, toRaw, markRaw } from 'vue';
...
import { m as sanitizeStatusCode, n as createHooks, i as createError$1, t as toRouteMatcher, o as createRouter } from '../runtime.mjs';
import { getActiveHead, CapoPlugin } from 'unhead';
import { ssrRenderAttrs, ssrRenderList, ssrInterpolate, ssrRenderClass, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderStyle, ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'vue/server-renderer';
...
const router_OgIDfckZA1 = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:router",
  enforce: "pre",
  setup(nuxtApp) {
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/getJobs", "$siNM9WAguS")), __temp = await __temp, __restore(), __temp);
    const jobType = ref("goto");
    const destination = ref("gang1");
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container" }, _attrs))}><h1>Marvin Control Center</h1><section><h2>Jobs</h2><table><thead><tr><th>ID</th><th>Type</th><th>Data</th><th>State</th></tr></thead><tbody><!--[-->`);
      ssrRenderList(unref(data), (job) => {
        _push(`<tr><td>${ssrInterpolate(job.id)}</td><td>${ssrInterpolate(job.type)}</td><td>${ssrInterpolate(job.data)}</td><td class="${ssrRenderClass(`state state-${job.state}`)}">${ssrInterpolate(job.state)}</td></tr>`);
      });
      _push(`<!--]--></tbody></table></section><section><h2>Schedule job</h2><form><label for="job-type">Job type</label><select id="job-type"><option value="goto"${ssrIncludeBooleanAttr(Array.isArray(unref(jobType)) ? ssrLooseContain(unref(jobType), "goto") : ssrLooseEqual(unref(jobType), "goto")) ? " selected" : ""}>Goto</option><option value="playsound"${ssrIncludeBooleanAttr(Array.isArray(unref(jobType)) ? ssrLooseContain(unref(jobType), "playsound") : ssrLooseEqual(unref(jobType), "playsound")) ? " selected" : ""}>Playsound</option></select><label for="job-destination">Destination</label><select style="${ssrRenderStyle(unref(jobType) == "goto" ? null : { display: "none" })}" id="job-destination"><option value="origin"${ssrIncludeBooleanAttr(Array.isArray(unref(destination)) ? ssrLooseContain(unref(destination), "origin") : ssrLooseEqual(unref(destination), "origin")) ? " selected" : ""}>Origin</option><option value="gang1"${ssrIncludeBooleanAttr(Array.isArray(unref(destination)) ? ssrLooseContain(unref(destination), "gang1") : ssrLooseEqual(unref(destination), "gang1")) ? " selected" : ""}>Gang 1</option><option value="gang2"${ssrIncludeBooleanAttr(Array.isArray(unref(destination)) ? ssrLooseContain(unref(destination), "gang2") : ssrLooseEqual(unref(destination), "gang2")) ? " selected" : ""}>Gang 2</option><option value="gang3"${ssrIncludeBooleanAttr(Array.isArray(unref(destination)) ? ssrLooseContain(unref(destination), "gang3") : ssrLooseEqual(unref(destination), "gang3")) ? " selected" : ""}>Gang 3</option><option value="gang4"${ssrIncludeBooleanAttr(Array.isArray(unref(destination)) ? ssrLooseContain(unref(destination), "gang4") : ssrLooseEqual(unref(destination), "gang4")) ? " selected" : ""}>Gang 4</option><option value="gang5"${ssrIncludeBooleanAttr(Array.isArray(unref(destination)) ? ssrLooseContain(unref(destination), "gang5") : ssrLooseEqual(unref(destination), "gang5")) ? " selected" : ""}>Gang 5</option><option value="gang6"${ssrIncludeBooleanAttr(Array.isArray(unref(destination)) ? ssrLooseContain(unref(destination), "gang6") : ssrLooseEqual(unref(destination), "gang6")) ? " selected" : ""}>Gang 6</option><option value="gang7"${ssrIncludeBooleanAttr(Array.isArray(unref(destination)) ? ssrLooseContain(unref(destination), "gang7") : ssrLooseEqual(unref(destination), "gang7")) ? " selected" : ""}>Gang 7</option><option value="gang8"${ssrIncludeBooleanAttr(Array.isArray(unref(destination)) ? ssrLooseContain(unref(destination), "gang8") : ssrLooseEqual(unref(destination), "gang8")) ? " selected" : ""}>Gang 8</option><option value="gang9"${ssrIncludeBooleanAttr(Array.isArray(unref(destination)) ? ssrLooseContain(unref(destination), "gang9") : ssrLooseEqual(unref(destination), "gang9")) ? " selected" : ""}>Gang 9</option><option value="podium1"${ssrIncludeBooleanAttr(Array.isArray(unref(destination)) ? ssrLooseContain(unref(destination), "podium1") : ssrLooseEqual(unref(destination), "podium1")) ? " selected" : ""}>Podium 1</option><option value="podium2"${ssrIncludeBooleanAttr(Array.isArray(unref(destination)) ? ssrLooseContain(unref(destination), "podium2") : ssrLooseEqual(unref(destination), "podium2")) ? " selected" : ""}>Podium 2</option><option value="escher1"${ssrIncludeBooleanAttr(Array.isArray(unref(destination)) ? ssrLooseContain(unref(destination), "escher1") : ssrLooseEqual(unref(destination), "escher1")) ? " selected" : ""}>Escher 1</option><option value="escher2"${ssrIncludeBooleanAttr(Array.isArray(unref(destination)) ? ssrLooseContain(unref(destination), "escher2") : ssrLooseEqual(unref(destination), "escher2")) ? " selected" : ""}>Escher 2</option></select><button class="submit-button">Sumbmit</button></form></section></div>`);
    };
  }
});
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-B894mcFs.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-BvwZo6z_.mjs').then((r) => r.default || r));
...
export { On as O, navigateTo as a, useRuntimeConfig as b, withoutTrailingSlash as c, resolveUnrefHeadInput as d, entry$1 as default, br as e, hasProtocol as h, injectHead as i, joinURL as j, nuxtLinkDefaults as n, parseQuery as p, resolveRouteObject as r, useRouter as u, withTrailingSlash as w };
